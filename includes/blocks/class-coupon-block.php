...
class Coupon_Block {
	...
	public function render_coupon_block( $attributes, $_, $block ) {
		$classes = array(
			'wpcd-coupon-wrapper',
			'wpcd-coupon-' . (isset($attributes['template']) ? $attributes['template'] : 'default') . '-template',
		);
		...
		$wrapperStyles = array(
			...
			'padding-top' => !empty($paddingObj) && isset($paddingObj['top']) ? $paddingObj['top'] : '25px',
			'padding-right' => !empty($paddingObj) && isset($paddingObj['right']) ? $paddingObj['right'] : '25px',
			'padding-bottom' => !empty($paddingObj) && isset($paddingObj['bottom']) ? $paddingObj['bottom'] : '25px',
			'padding-left' => !empty($paddingObj) && isset($paddingObj['left']) ? $paddingObj['left'] : '25px',
			...
			'border-top' => !is_value_empty(get_single_side_border_value($wrapperBorder, 'top')) ? get_single_side_border_value($wrapperBorder, 'top') : '2px dashed #000000',
			'border-left' => !is_value_empty(get_single_side_border_value($wrapperBorder, 'left')) ? get_single_side_border_value($wrapperBorder, 'left') : '2px dashed #000000',
			'border-right' => !is_value_empty(get_single_side_border_value($wrapperBorder, 'right')) ? get_single_side_border_value($wrapperBorder, 'right') : '2px dashed #000000',
			'border-bottom' => !is_value_empty(get_single_side_border_value($wrapperBorder, 'bottom')) ? get_single_side_border_value($wrapperBorder, 'bottom') : '2px dashed #000000',
		);
		...
		$block_html = $this->generate_coupon_html( $attributes );
	...
	public function generate_coupon_html( $attributes ) {
		...
		$separatorBorder = get_border_css($attributes['separatorBorder']);
