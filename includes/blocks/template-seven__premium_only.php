<?php
function wpcd_get_template_seven( $attributes ){
          ...
          <div class="wpcd-coupon-details-wrapper wpcd-coupon-column-1">
               <div class="wpcd-coupon-header">
                    ...
                    <div class="wpcd-coupon-code">
                         ...
                         <?php else : ?>
                              <a  data-coupon_code="<?php echo isset($attributes['dealButtonText']) ? esc_attr($attributes['dealButtonText']) : ''; ?>" rel="nofollow noopener" target="_blank" href="<?php echo esc_url( $attributes['navigationLink'] ); ?>" class="wpcd-coupon-button" style="<?php echo esc_attr( generate_css_string( $codeStyles ) ); ?>" title="<?php esc_attr_e( 'Click To Claim This Deal', 'wp-coupons-and-deals' ); ?>">
