...
function wpcd_widget_help_info() { ?>
    ...
    <div class="wpcd_widget_help_info">
        <p><?php _e( 'From the list, select the coupon you want to show on the widget and click on the Save button. 	If you have not created any coupons,', 'wp-coupons-and-deals' ); ?>
            <a href="<?php echo get_admin_url() . 'post-new.php?post_type=wpcd_coupons'; ?>" target="_blank">
				<?php _e( 'create one', 'wp-coupons-and-deals' ); ?>
            </a>
            or
            <a href="<?php echo get_admin_url() . 'edit.php?post_type=wpcd_coupons'; ?>" target="_blank">
				<?php _e( 'manage your coupons', 'wp-coupons-and-deals' ); ?>
            </a>.
        </p>
