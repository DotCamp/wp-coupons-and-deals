...
<p style="font-size: 16px;"><?php echo '<a style="font-weight:bold;" href="' . wcad_fs()->get_upgrade_url() . '">' . __( 'Upgrade to Pro!', 'wpcd-coupon' ) . '</a>' . __( ' to start using this feature.', 'wpcd-coupon' ); ?></p>
