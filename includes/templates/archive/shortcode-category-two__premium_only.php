...
?>
<!--- Template two start -->
<div class="wpcd-coupon-two wpcd-coupon-id-<?php echo absint( $coupon_id ); ?> wpcd_item"  <?php echo $wpcd_uniq_attr ? 'data-unic-attr="' . esc_attr( $wpcd_uniq_attr ) . '"' : '';?>>
                        ...
                        <div class="wpcd-coupon-code">
                            <a rel="nofollow" href="<?php echo esc_url( $link ); ?>"
                               ...
                               data-clipboard-text="<?php echo esc_attr( $coupon_code ); ?>">
                                ...
                                <span id="coupon_code_<?php echo absint( $coupon_id ); ?>" style="display:none;">
                                    <?php echo esc_html( $coupon_code ); ?>
                                </span>
                            </a>
                        </div>
