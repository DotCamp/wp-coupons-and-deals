    ...
    <div class="wpcd-col-two-1-4">
        <figure>
            ...
            if ($link_thumbnail == "on"):
                echo "<a class='wpcd-coupon-click-link' data-id='{$coupon_id}' href='{$link}' rel='nofollow' target='{$target}'><img class='wpcd-coupon-two-img' src='{$coupon_thumbnail}' alt='{$title}'></a>";
            else:
