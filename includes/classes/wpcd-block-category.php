 ...
 * @since 1.1.1
 */
class WPCD_Block_Category {

	/**
	 * This class's instance.
	 *
	 * @var WPCD_Block_Category
	 */
	...
	public static function register() {
		if ( null === self::$instance ) {
			self::$instance = new WPCD_Block_Category();
		}
	}
	...
	public function block_categories( $categories ) {
		...
		return array_merge(
			array(
				array(
					'slug'  => 'wpcd',
					'title' => __( 'WP Coupons and deals', 'wp-coupons-and-deals' ),
				),
			),
			$categories
		);
