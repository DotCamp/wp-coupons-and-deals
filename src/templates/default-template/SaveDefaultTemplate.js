...
function DefaultTemplate(props) {
  ...
  const navigationAttrs = !hideCoupon
      ...
      <div className="ub-coupon-details-wrapper">
          ...
          <div className="ub-coupon-code">
            {couponType !== "deal" && (
              ...
              >
                ...
                <RichText.Content value={code} tagName="span" />
              </a>
            )}
            {couponType === "deal" && (
              <a
              ...
              >
                <RichText.Content value={dealButtonText} tagName="span" />
              </a>
            )}
          </div>
        </div>
        <div className="ub-coupon-content">
          <div className="ub-coupon-description">
            <RichText.Content value={description} tagName="p" />
          </div>
          <div
          ...
          >
            ...
            {isDoesNotExpire && (
              <RichText.Content tagName="span" value={doesNotExpireText} />
            )}
          </div>
        </div>
      </div>
