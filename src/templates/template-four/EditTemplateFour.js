...
function TemplateFour(props) {
  ...
  const secondExpirationDateInLocalString = secondDate
    .toLocaleDateString("en-GB")
    .replace(/\//g, "-");
  const thirdDate = new Date(thirdExpirationDate);
  const thirdExpirationDateInLocalString = thirdDate
    .toLocaleDateString("en-GB")
    .replace(/\//g, "-");
  return (
      ...
      <div className="wpcd-coupon-details-wrapper wpcd-coupon-column-1">
        <div className="wpcd-coupon-header">
          ...
          <div className="wpcd-coupon-content-wrapper">
            ...
            >
              <div className="wpcd-coupon-content-inner-wrapper">
                <div className="wpcd-coupon-discount-wrapper">
                  <div className="wpcd-coupon-discount-inner__wrapper">
                    <RichText
                      ...
                      tagName="div"
                      onChange={(newValue) =>
                        setAttributes({ discount: newValue })
                      }
              ...
              <div className="wpcd-coupon-content-inner-wrapper">
                <div className="wpcd-coupon-discount-wrapper">
                  <div className="wpcd-coupon-discount-inner__wrapper">
                    <RichText
                      ...
                      tagName="div"
                      onChange={(newValue) =>
                        setAttributes({ secondDiscount: newValue })
                      }
                      placeholder={__("100%", "wp-coupons-and-deals")}
                      style={generateStyles(discountStyles)}
                    />
                ...
                >
                  {!isDoesNotExpire ? (
                    <>
                      <span>Expire On: </span>
                      <span>{secondExpirationDateInLocalString}</span>
                    </>
                  ) : (
                    <span>{doesNotExpireText}</span>
                  )}
                  ...
                  {couponType !== "deal" ? (
                    ...
                    >
                      ...
                      <RichText
                        ...
                        tagName="span"
                        onChange={(newValue) =>
                          setAttributes({ secondCode: newValue })
                        }
                        placeholder={__("SAMPLECODE", "wp-coupons-and-deals")}
                      />
                    </a>
                    ...
                    >
                      <RichText
                        ...
                        tagName="span"
                        onChange={(newValue) =>
                          setAttributes({ secondDealButtonText: newValue })
                        }
                        placeholder={__("Get Deal", "wp-coupons-and-deals")}
                      />
                    </a>
              ...
              <div className="wpcd-coupon-content-inner-wrapper">
                <div className="wpcd-coupon-discount-wrapper">
                  <div className="wpcd-coupon-discount-inner__wrapper">
                    <RichText
                      ...
                      tagName="div"
                      onChange={(newValue) =>
                        setAttributes({ thirdDiscount: newValue })
                      }
                      placeholder={__("100%", "wp-coupons-and-deals")}
                      style={generateStyles(discountStyles)}
                    />
                ...
                >
                  {!isDoesNotExpire ? (
                    <>
                      <span>Expire On: </span>
                      <span>{thirdExpirationDateInLocalString}</span>
                    </>
                  ) : (
                    <span>{doesNotExpireText}</span>
                  )}
                  ...
                  {couponType !== "deal" ? (
                    ...
                    >
                      ...
                      <RichText
                        ...
                        tagName="span"
                        onChange={(newValue) =>
                          setAttributes({ thirdCode: newValue })
                        }
                        placeholder={__("SAMPLECODE", "wp-coupons-and-deals")}
                      />
                    </a>
                    ...
                    >
                      <RichText
                        ...
                        tagName="span"
                        onChange={(newValue) =>
                          setAttributes({ thirdDealButtonText: newValue })
                        }
                        placeholder={__("Get Deal", "wp-coupons-and-deals")}
                      />
                    </a>
